  ...
  _createClass(FileRouteResolver, [{
    ...
    value: function () {
      var _getHandlers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var directory,
          _yield$this$scanDirec,
          _yield$this$scanDirec2,
          middlewares,
          routes,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              _yield$this$scanDirec = _context.sent;
              _yield$this$scanDirec2 = _slicedToArray(_yield$this$scanDirec, 2);
              middlewares = _yield$this$scanDirec2[0];
              routes = _yield$this$scanDirec2[1];
              return _context.abrupt("return", [middlewares.sort(function (left, right) {
                return left.nestingLevel - right.nestingLevel;
    ...
    key: "scanDirectory",
    value: function () {
      var _scanDirectory = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var directory,
          parentRoute,
          nestingLevel,
          entries,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              directory = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : this.baseDir;
              parentRoute = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : '';
              nestingLevel = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 0;
              _context2.next = 5;
            ...
            case 11:
              ...
              entry = _step.value;
              _context2.next = 15;
              return this.processEntry(directory, parentRoute, nestingLevel, entry);
            case 15:
              _yield$this$processEn = _context2.sent;
    ...
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return this.scanDirectory(fullPath, routePath, nestingLevel + 1);
            case 7:
              _yield$this$scanDirec3 = _context3.sent;
            ...
            case 15:
              ...
              _context3.next = 19;
              return this.processMiddlewareEntry(fullPath, routePath, nestingLevel);
            case 19:
      ...
      function processEntry(_x2, _x3, _x4, _x5) {
        return _processEntry.apply(this, arguments);
      }
      return processEntry;
    }()
  }, {
    ...
    key: "processMiddlewareEntry",
    value: function () {
      var _processMiddlewareEntry = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(fullPath, filePath, nestingLevel) {
        var handler, routePath;
      ...
      function processMiddlewareEntry(_x6, _x7, _x8) {
        return _processMiddlewareEntry.apply(this, arguments);
      }
      return processMiddlewareEntry;
    }()
  }, {
...
_defineProperty(FileRouteResolver, "middlewareFilePattern", new RegExp("middleware\\.(".concat(FileRouteResolver.fileExtensions, ")$")));
