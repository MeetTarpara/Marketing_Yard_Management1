...
exports.initFileRouter = initFileRouter;
var path = _interopRequireWildcard(require("node:path"));
var process = _interopRequireWildcard(require("node:process"));
var _fileRouteResolver = require("./components/file-route-resolver");
var _object = require("./utils/object.utils");
var _notFoundResolver = require("./components/not-found-resolver");
var _httpAdapter = require("./adapters/http-adapter");
var _validations = require("./validations/validations");
var _middlewareExecuter = require("./components/middleware-executer");
...
function initFileRouter() {
  return _initFileRouter.apply(this, arguments);
}
function _initFileRouter() {
  _initFileRouter = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _ref,
      _ref$baseDir,
      baseDir,
      ignoreFilesRegex,
      _ref$clearImportCache,
      clearImportCache,
      _ref$adapter,
      adapter,
      getPathname,
      ...
      normalizedBaseDir,
      fileRouteResolver,
      _yield$fileRouteResol,
      _yield$fileRouteResol2,
      middlewares,
      routeHandlers,
      notFoundHandler,
      extractMiddlewares,
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          runHandler = function _runHandler(pathname, method, args) {
            ...
            if (!matchedRoute) {
              return notFoundHandler.apply(void 0, _toConsumableArray(args));
            }
            ...
            if ((0, _object.isRecordWith)(handler) && method && handler[method]) {
              return handler[method].apply(handler, _toConsumableArray(args).concat([routeParams]));
            }
            if ((0, _object.isFunction)(handler)) {
              return handler.apply(void 0, _toConsumableArray(args).concat([routeParams]));
            }
            ...
            return notFoundHandler.apply(void 0, _toConsumableArray(args).concat([routeParams]));
          };
        ...
        case 10:
          ...
          _yield$fileRouteResol2 = _slicedToArray(_yield$fileRouteResol, 2);
          middlewares = _yield$fileRouteResol2[0];
        ...
        case 19:
          ...
          return _context.abrupt("return", function requestHandler() {
            ...
            var pathname = getPathname.apply(void 0, args);
