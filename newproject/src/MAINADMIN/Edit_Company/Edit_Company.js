...
const Edit_Company = () => {
    ...
    useEffect(()=>{
        fetch(`http://localhost:4000/admin/${params.id}`)
        .then(res=>res.json())
        .then(res=>setCompany(res));
    },[])
    function edited() {
        console.log(company)
        axios.patch(`http://localhost:4000/admin/${params.id}`,company)
                ...
                <div className='Rform'>
                    ...
                    <div class="r_form">
                        <form>
                            ...
                            <div class="input_wrap p-2">
                                <label for="collagename" style={{ display: "block", fontSize: 15 }}>Password :</label>
